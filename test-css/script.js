...
const pokemon_index = 2;

const pokemon_species_url = "https://pokeapi.co/api/v2/pokemon-species/" + pokemon_index.toString(); 

const pokemon_name_url = "https://pokeapi.co/api/v2/pokemon/" + pokemon_index.toString() 
...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    pokemon_name_data = await pokemonCall(url)
